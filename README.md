...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1cc792c0-dc51-458b-ac91-af2e8b4605e6
```

> `1cc792c0-dc51-458b-ac91-af2e8b4605e6` is the password of the certificate, you can change it to any password you want.
